---
description: Generates or improves technical proposals (MiniMax-M3 via minimax-coding-plan; Group C: temperature sweep T=0.0, top_p sweep P=0.0, clone 03 of 03)
mode: subagent
