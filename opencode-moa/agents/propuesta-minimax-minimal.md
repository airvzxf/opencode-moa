---
description: Generates or improves technical proposals (MiniMax-M3 via minimax-coding-plan; Group B: minimal priority injection v1.2.1 — directive prepended)
mode: subagent
