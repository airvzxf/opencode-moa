---
description: Generates or improves technical proposals (MiniMax-M3 via minimax-coding-plan; Group C: temperature sweep T=1.5 out-of-Anthropic-spec, may clamp)
mode: subagent
